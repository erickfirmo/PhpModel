...
```
By default, the `pages` attribute of the <a href="https://github.com/erickfirmo/PhpModel/blob/master/README.md#collections">collections</a> will be an array with the number of pages:
